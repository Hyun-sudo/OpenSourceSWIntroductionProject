/*
 * ASUS ROG Aura Core RGB Lighting Controller
 * 의 정의와 타입 선언
*/
...
public:
    ...
    void    SendUpdate(unsigned char zone, unsigned char mode, unsigned char speed, unsigned char red, unsigned char green, unsigned char blue);
    void    SendSet();
    void    SendApply();
