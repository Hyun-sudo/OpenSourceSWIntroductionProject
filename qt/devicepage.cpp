...
DevicePage::DevicePage(RGBController *dev,QWidget *parent) : QFrame(parent), ui(new Ui::DevicePageUi)
{
    ui->setupUi(this);
...
void DevicePage::on_ZoneBox_currentIndexChanged()
{
    // 선택한 모드 읽기
...
void DevicePage::on_LEDBox_currentIndexChanged(int index)
{
    // 선택한 모드 읽기
    unsigned int selected_mode   = (unsigned int)ui->ModeBox->currentIndex();
        ...
        case MODE_COLORS_PER_LED:
            {
                ...
                // 선택한 LED의 색으로 color picker 업데이트
                UpdatingColor = true;
...
void DevicePage::on_ModeBox_currentIndexChanged(int /*index*/)
{
    /*-----------------------------------------------------*\
...
void DevicePage::on_PerLEDCheck_clicked()
{
    /*-----------------------------------------------------*\
    | Change device mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_ModeSpecificCheck_clicked()
{
    /*-----------------------------------------------------*\
    | Change device mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_RandomCheck_clicked()
{
    /*-----------------------------------------------------*\
    | Change device mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_SpeedSlider_valueChanged(int /*value*/)
{
    /*-----------------------------------------------------*\
    | Change device mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_DirectionBox_currentIndexChanged(int /*index*/)
{
    /*-----------------------------------------------------*\
    | Change device mode                                    |
    \*-----------------------------------------------------*/
    ...
    if(selected_mode < device->modes.size())
    {
        ...
        switch(device->modes[selected_mode].color_mode)
        {
            ...
            case MODE_COLORS_PER_LED:
                ...
                | Update LED box                                        |
                \*-----------------------------------------------------*/
                on_ZoneBox_currentIndexChanged();
...
void DevicePage::SetDevice(unsigned char red, unsigned char green, unsigned char blue)
{
    UpdatingColor = true;
...
void DevicePage::on_SetDeviceButton_clicked()
{
    /*-----------------------------------------------------*\
    | Read selected mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_SetZoneButton_clicked()
{
    /*-----------------------------------------------------*\
    | Read selected mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_SetLEDButton_clicked()
{
    /*-----------------------------------------------------*\
    | Read selected mode                                    |
    \*-----------------------------------------------------*/
...
void DevicePage::on_ButtonRed_clicked()
{
    UpdatingColor = true;
...
void DevicePage::on_ButtonYellow_clicked()
{
    UpdatingColor = true;
    ui->RedSpinBox->setValue(255);
...
void DevicePage::on_ButtonGreen_clicked()
{
    UpdatingColor = true;
...
void DevicePage::on_ButtonCyan_clicked()
{
    UpdatingColor = true;
    ui->RedSpinBox->setValue(0);
    ui->GreenSpinBox->setValue(255);
...
void DevicePage::on_ButtonBlue_clicked()
{
    UpdatingColor = true;
    ui->RedSpinBox->setValue(0);
    ui->GreenSpinBox->setValue(0);
...
void DevicePage::on_ButtonMagenta_clicked()
{
    UpdatingColor = true;
    ui->RedSpinBox->setValue(255);
    ui->GreenSpinBox->setValue(0);
...
void DevicePage::on_RedSpinBox_valueChanged(int /*arg1*/)
{
    updateHSV();
}

void DevicePage::on_HueSpinBox_valueChanged(int /*arg1*/)
{
    updateRGB();
}

void DevicePage::on_GreenSpinBox_valueChanged(int /*arg1*/)
{
    updateHSV();
}

void DevicePage::on_SatSpinBox_valueChanged(int /*arg1*/)
{
    updateRGB();
}

void DevicePage::on_BlueSpinBox_valueChanged(int /*arg1*/)
{
    updateHSV();
}

void DevicePage::on_ValSpinBox_valueChanged(int /*arg1*/)
{
    updateRGB();
}

void DevicePage::on_SetAllButton_clicked()
{
...
void DevicePage::on_ResizeButton_clicked()
{
    ...
    case MODE_COLORS_PER_LED:
        {
            ...
            {
                ZoneResizeDialog dlg(device->zones[selected_zone].leds_min,
    ...
    case MODE_COLORS_MODE_SPECIFIC:
        {
             ZoneResizeDialog dlg(device->modes[device->active_mode].colors_min,
